...
Secret sharing is a method used in distributing a secret amongst a group of participants, each of whom is allocated a "share" of the secret.  The secret can be reconstructed only when a sufficient number of shares are combined together.  As a result, the individual shares, alone, provide no useful information.  In our system secret sharing is used to distribute the broker role to multiple nodes
